...
document.writeln("                <a href=\"index/index.jsp\"  target=\"_Blank\"><i class=\"fa fa-desktop fatest\"></i>See SDUSTOJ</a>");
document.writeln("            </li>");
...
document.writeln("                <ul class=\"submenu\">");
document.writeln("                    <li class=\"menuli\"><a href=\"javascript:;\" >AddNews</a></li>            <!--添加OJ帖子-->");
document.writeln("                    <li class=\"menuli\"><a href=\"javascript:;\" >NewsList</a></li>            <!--查看OJ帖子列表-->");
...
document.writeln("                <ul class=\"submenu\">");
document.writeln("                    <li class=\"menuli\"><a href=\"admin/user/adduser.jsp\">AddPrivilege</a></li> <!--设置管理员-->");
document.writeln("                    <li class=\"menuli\"><a href=\"admin/user/userlist.jsp\">PrivilegeList</a></li>    <!--管理员列表-->");
